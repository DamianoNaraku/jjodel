...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p style=\"display:none;\">test console</p>\r\n");
...
class LocalStorage {
    ...
    saveModel(isAutosave, saveAs = false) {
        ...
        if (saveAs) {
            popup = new _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["InputPopup"]('Choose a name for the ' + model.friendlyClassName(), '', '', [['change', onchange], ['keydown', onkeydown], ['blur', onblur]], 'Viewpoint', model.friendlyClassName() + ' name', '');
            popup.show();
            return;
        }
...
class Model extends _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["IModel"] {
    ...
    parse(json, destructive, metamodel = null) {
        ...
        _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].pw(json === '' + json, 'ModelPiece.parse() parameter must be a parsed ECORE/json. autofixed.');
        if (json === '' + json)
...
class ModelPiece {
    ...
    getHtmlOnGraph() {
        if (this instanceof _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["IPackage"])
            return null;
        let html = this.getVertex().getHtml();
        if (this instanceof _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["IClass"])
            return html;
    ...
    */
    ...
    pushUp() {
        ...
        if ((arr = parent.childrens) && (i = arr.indexOf(this)) !== -1) {
            ...
            _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].arrayInsertAt(arr, i - 1, this);
        }
...
function main() {
    ...
    const mmconsole = new _common_Joiner__WEBPACK_IMPORTED_MODULE_12__["MyConsole"]($('.mmconsole')[0]);
    const mconsole = new _common_Joiner__WEBPACK_IMPORTED_MODULE_12__["MyConsole"]($('.mconsole')[0]);
    let tmp;
    let useless;
    let i;
    ...
    const validate = (thing, defaultvalue) => { return tmp && tmp !== '' && tmp !== 'null' && tmp !== 'undefined' ? thing : defaultvalue; };
...
/* harmony import */ var _common_prj_json2xml_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../common/prj_json2xml.js */ "./src/common/prj_json2xml.js");
/* harmony import */ var _common_prj_xml2json_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../common/prj_xml2json.js */ "./src/common/prj_xml2json.js");
/* harmony import */ var _GuiStyles_viewpoint__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../GuiStyles/viewpoint */ "./src/GuiStyles/viewpoint.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ViewHtmlSettings", function() { return _GuiStyles_viewpoint__WEBPACK_IMPORTED_MODULE_7__["ViewHtmlSettings"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ViewPoint", function() { return _GuiStyles_viewpoint__WEBPACK_IMPORTED_MODULE_7__["ViewPoint"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ViewRule", function() { return _GuiStyles_viewpoint__WEBPACK_IMPORTED_MODULE_7__["ViewRule"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EdgeViewRule", function() { return _GuiStyles_viewpoint__WEBPACK_IMPORTED_MODULE_7__["EdgeViewRule"]; });

/* harmony import */ var _Database_LocalStorage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../Database/LocalStorage */ "./src/Database/LocalStorage.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LocalStorage", function() { return _Database_LocalStorage__WEBPACK_IMPORTED_MODULE_8__["LocalStorage"]; });

/* harmony import */ var _Model_modelPiece__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Model/modelPiece */ "./src/Model/modelPiece.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ModelPiece", function() { return _Model_modelPiece__WEBPACK_IMPORTED_MODULE_9__["ModelPiece"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Info", function() { return _Model_modelPiece__WEBPACK_IMPORTED_MODULE_9__["Info"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ModelNone", function() { return _Model_modelPiece__WEBPACK_IMPORTED_MODULE_9__["ModelNone"]; });

/* harmony import */ var _Model_iModel__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../Model/iModel */ "./src/Model/iModel.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ECoreEnum", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["ECoreEnum"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EcoreLiteral", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["EcoreLiteral"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ECoreParameter", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["ECoreParameter"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ECoreOperation", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["ECoreOperation"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ECoreAttribute", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["ECoreAttribute"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ECoreReference", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["ECoreReference"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ECoreClass", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["ECoreClass"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ECorePackage", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["ECorePackage"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ECoreRoot", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["ECoreRoot"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ECoreAnnotation", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["ECoreAnnotation"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ECoreDetail", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["ECoreDetail"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "XMIModel", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["XMIModel"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IModel", function() { return _Model_iModel__WEBPACK_IMPORTED_MODULE_10__["IModel"]; });

/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./util */ "./src/common/util.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ShortAttribETypes", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["ShortAttribETypes"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "U", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["U"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Json", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["Json"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AttribETypes", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["AttribETypes"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "InputPopup", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["InputPopup"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DetectZoom", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["DetectZoom"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Dictionary", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["Dictionary"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MeasurableArrays", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["MeasurableArrays"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IPoint", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["IPoint"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Point", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["Point"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GraphPoint", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["GraphPoint"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ISize", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["ISize"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Size", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["Size"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GraphSize", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["GraphSize"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "myFileReader", function() { return _util__WEBPACK_IMPORTED_MODULE_11__["myFileReader"]; });

/* harmony import */ var _src_app_app_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../src/app/app.module */ "./src/app/app.module.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Status", function() { return _src_app_app_module__WEBPACK_IMPORTED_MODULE_12__["Status"]; });

/* harmony import */ var _guiElements_mGraph_iGraph__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../guiElements/mGraph/iGraph */ "./src/guiElements/mGraph/iGraph.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IGraph", function() { return _guiElements_mGraph_iGraph__WEBPACK_IMPORTED_MODULE_13__["IGraph"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ViewPointShell", function() { return _guiElements_mGraph_iGraph__WEBPACK_IMPORTED_MODULE_13__["ViewPointShell"]; });

/* harmony import */ var _guiElements_mGraph_Vertex_iVertex__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../guiElements/mGraph/Vertex/iVertex */ "./src/guiElements/mGraph/Vertex/iVertex.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IVertex", function() { return _guiElements_mGraph_Vertex_iVertex__WEBPACK_IMPORTED_MODULE_14__["IVertex"]; });

/* harmony import */ var _guiElements_mGraph_Field_iField__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../guiElements/mGraph/Field/iField */ "./src/guiElements/mGraph/Field/iField.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IField", function() { return _guiElements_mGraph_Field_iField__WEBPACK_IMPORTED_MODULE_15__["IField"]; });

/* harmony import */ var _guiElements_isidebar_isidebar_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../guiElements/isidebar/isidebar.component */ "./src/guiElements/isidebar/isidebar.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ISidebar", function() { return _guiElements_isidebar_isidebar_component__WEBPACK_IMPORTED_MODULE_16__["ISidebar"]; });

/* harmony import */ var _guiElements_mGraph_Edge_iEdge__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../guiElements/mGraph/Edge/iEdge */ "./src/guiElements/mGraph/Edge/iEdge.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IEdge", function() { return _guiElements_mGraph_Edge_iEdge__WEBPACK_IMPORTED_MODULE_17__["IEdge"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EdgeModes", function() { return _guiElements_mGraph_Edge_iEdge__WEBPACK_IMPORTED_MODULE_17__["EdgeModes"]; });

/* harmony import */ var _guiElements_mGraph_Edge_ExtEdge__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../guiElements/mGraph/Edge/ExtEdge */ "./src/guiElements/mGraph/Edge/ExtEdge.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ExtEdge", function() { return _guiElements_mGraph_Edge_ExtEdge__WEBPACK_IMPORTED_MODULE_18__["ExtEdge"]; });

/* harmony import */ var _guiElements_mGraph_Edge_EdgePoint__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../guiElements/mGraph/Edge/EdgePoint */ "./src/guiElements/mGraph/Edge/EdgePoint.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EdgePoint", function() { return _guiElements_mGraph_Edge_EdgePoint__WEBPACK_IMPORTED_MODULE_19__["EdgePoint"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EdgePointFittizio", function() { return _guiElements_mGraph_Edge_EdgePoint__WEBPACK_IMPORTED_MODULE_19__["EdgePointFittizio"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CursorFollowerEP", function() { return _guiElements_mGraph_Edge_EdgePoint__WEBPACK_IMPORTED_MODULE_19__["CursorFollowerEP"]; });

/* harmony import */ var _guiElements_mGraph_Edge_edgeStyle__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../guiElements/mGraph/Edge/edgeStyle */ "./src/guiElements/mGraph/Edge/edgeStyle.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EdgeStyle", function() { return _guiElements_mGraph_Edge_edgeStyle__WEBPACK_IMPORTED_MODULE_20__["EdgeStyle"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EdgePointStyle", function() { return _guiElements_mGraph_Edge_edgeStyle__WEBPACK_IMPORTED_MODULE_20__["EdgePointStyle"]; });

/* harmony import */ var _guiElements_propertyBar_propertyBar__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../guiElements/propertyBar/propertyBar */ "./src/guiElements/propertyBar/propertyBar.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PropertyBarr", function() { return _guiElements_propertyBar_propertyBar__WEBPACK_IMPORTED_MODULE_21__["PropertyBarr"]; });

/* harmony import */ var _guiElements_top_bar_top_bar_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../guiElements/top-bar/top-bar.component */ "./src/guiElements/top-bar/top-bar.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TopBar", function() { return _guiElements_top_bar_top_bar_component__WEBPACK_IMPORTED_MODULE_22__["TopBar"]; });

/* harmony import */ var _guiElements_style_editor_style_editor_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../guiElements/style-editor/style-editor.component */ "./src/guiElements/style-editor/style-editor.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "StyleEditor", function() { return _guiElements_style_editor_style_editor_component__WEBPACK_IMPORTED_MODULE_23__["StyleEditor"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SaveListEntry", function() { return _Database_LocalStorage__WEBPACK_IMPORTED_MODULE_8__["SaveListEntry"]; });

/* harmony import */ var _guiElements_console_console_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../guiElements/console/console.component */ "./src/guiElements/console/console.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MyConsole", function() { return _guiElements_console_console_component__WEBPACK_IMPORTED_MODULE_24__["MyConsole"]; });

/* harmony import */ var _Model_MetaMetaModel__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../Model/MetaMetaModel */ "./src/Model/MetaMetaModel.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MetaMetaModel", function() { return _Model_MetaMetaModel__WEBPACK_IMPORTED_MODULE_25__["MetaMetaModel"]; });

/* harmony import */ var _Model_MetaModel__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../Model/MetaModel */ "./src/Model/MetaModel.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MetaModel", function() { return _Model_MetaModel__WEBPACK_IMPORTED_MODULE_26__["MetaModel"]; });

/* harmony import */ var _Model_Model__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../Model/Model */ "./src/Model/Model.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Model", function() { return _Model_Model__WEBPACK_IMPORTED_MODULE_27__["Model"]; });

/* harmony import */ var _Model_mPackage_iPackage__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../Model/mPackage/iPackage */ "./src/Model/mPackage/iPackage.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IPackage", function() { return _Model_mPackage_iPackage__WEBPACK_IMPORTED_MODULE_28__["IPackage"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "M3Package", function() { return _Model_mPackage_iPackage__WEBPACK_IMPORTED_MODULE_28__["M3Package"]; });

/* harmony import */ var _Model_mPackage_MMPackage__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../Model/mPackage/MMPackage */ "./src/Model/mPackage/MMPackage.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "M2Package", function() { return _Model_mPackage_MMPackage__WEBPACK_IMPORTED_MODULE_29__["M2Package"]; });

/* harmony import */ var _Model_mPackage_MPackage_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ../Model/mPackage/MPackage.component */ "./src/Model/mPackage/MPackage.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MPackage", function() { return _Model_mPackage_MPackage_component__WEBPACK_IMPORTED_MODULE_30__["MPackage"]; });

/* harmony import */ var _mClass_IClassifier__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ../mClass/IClassifier */ "./src/mClass/IClassifier.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IClassifier", function() { return _mClass_IClassifier__WEBPACK_IMPORTED_MODULE_31__["IClassifier"]; });

/* harmony import */ var _mClass_iClass__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../mClass/iClass */ "./src/mClass/iClass.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IClass", function() { return _mClass_iClass__WEBPACK_IMPORTED_MODULE_32__["IClass"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "M3Class", function() { return _mClass_iClass__WEBPACK_IMPORTED_MODULE_32__["M3Class"]; });

/* harmony import */ var _mClass_m2Class__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ../mClass/m2Class */ "./src/mClass/m2Class.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "M2Class", function() { return _mClass_m2Class__WEBPACK_IMPORTED_MODULE_33__["M2Class"]; });

/* harmony import */ var _mClass_MClass__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ../mClass/MClass */ "./src/mClass/MClass.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MClass", function() { return _mClass_MClass__WEBPACK_IMPORTED_MODULE_34__["MClass"]; });

/* harmony import */ var _mClass_EEnum__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ../mClass/EEnum */ "./src/mClass/EEnum.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EEnum", function() { return _mClass_EEnum__WEBPACK_IMPORTED_MODULE_35__["EEnum"]; });

/* harmony import */ var _mClass_classChild_Type__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ../mClass/classChild/Type */ "./src/mClass/classChild/Type.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Type", function() { return _mClass_classChild_Type__WEBPACK_IMPORTED_MODULE_36__["Type"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EType", function() { return _mClass_classChild_Type__WEBPACK_IMPORTED_MODULE_36__["EType"]; });

/* harmony import */ var _mClass_classChild_Typedd__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ../mClass/classChild/Typedd */ "./src/mClass/classChild/Typedd.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Typedd", function() { return _mClass_classChild_Typedd__WEBPACK_IMPORTED_MODULE_37__["Typedd"]; });

/* harmony import */ var _mClass_classChild_ELiteral__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ../mClass/classChild/ELiteral */ "./src/mClass/classChild/ELiteral.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ELiteral", function() { return _mClass_classChild_ELiteral__WEBPACK_IMPORTED_MODULE_38__["ELiteral"]; });

/* harmony import */ var _mClass_classChild_Features_iFeature__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ../mClass/classChild/Features/iFeature */ "./src/mClass/classChild/Features/iFeature.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IFeature", function() { return _mClass_classChild_Features_iFeature__WEBPACK_IMPORTED_MODULE_39__["IFeature"]; });

/* harmony import */ var _mClass_classChild_Features_References_iReference__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ../mClass/classChild/Features/References/iReference */ "./src/mClass/classChild/Features/References/iReference.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IReference", function() { return _mClass_classChild_Features_References_iReference__WEBPACK_IMPORTED_MODULE_40__["IReference"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "M3Reference", function() { return _mClass_classChild_Features_References_iReference__WEBPACK_IMPORTED_MODULE_40__["M3Reference"]; });

/* harmony import */ var _mClass_classChild_Features_References_M2Reference__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ../mClass/classChild/Features/References/M2Reference */ "./src/mClass/classChild/Features/References/M2Reference.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "M2Reference", function() { return _mClass_classChild_Features_References_M2Reference__WEBPACK_IMPORTED_MODULE_41__["M2Reference"]; });

/* harmony import */ var _mClass_classChild_Features_References_MReference__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ../mClass/classChild/Features/References/MReference */ "./src/mClass/classChild/Features/References/MReference.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MReference", function() { return _mClass_classChild_Features_References_MReference__WEBPACK_IMPORTED_MODULE_42__["MReference"]; });

/* harmony import */ var _mClass_classChild_Features_Attributes_iAttribute__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ../mClass/classChild/Features/Attributes/iAttribute */ "./src/mClass/classChild/Features/Attributes/iAttribute.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IAttribute", function() { return _mClass_classChild_Features_Attributes_iAttribute__WEBPACK_IMPORTED_MODULE_43__["IAttribute"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "M3Attribute", function() { return _mClass_classChild_Features_Attributes_iAttribute__WEBPACK_IMPORTED_MODULE_43__["M3Attribute"]; });

/* harmony import */ var _mClass_classChild_Features_Attributes_mmAttribute__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ../mClass/classChild/Features/Attributes/mmAttribute */ "./src/mClass/classChild/Features/Attributes/mmAttribute.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "M2Attribute", function() { return _mClass_classChild_Features_Attributes_mmAttribute__WEBPACK_IMPORTED_MODULE_44__["M2Attribute"]; });

/* harmony import */ var _mClass_classChild_Features_Attributes_MAttribute__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ../mClass/classChild/Features/Attributes/MAttribute */ "./src/mClass/classChild/Features/Attributes/MAttribute.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MAttribute", function() { return _mClass_classChild_Features_Attributes_MAttribute__WEBPACK_IMPORTED_MODULE_45__["MAttribute"]; });

/* harmony import */ var _Model_EAnnotation__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ../Model/EAnnotation */ "./src/Model/EAnnotation.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EAnnotation", function() { return _Model_EAnnotation__WEBPACK_IMPORTED_MODULE_46__["EAnnotation"]; });

/* harmony import */ var _Model_EAnnotationDetail__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ../Model/EAnnotationDetail */ "./src/Model/EAnnotationDetail.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EAnnotationDetail", function() { return _Model_EAnnotationDetail__WEBPACK_IMPORTED_MODULE_47__["EAnnotationDetail"]; });

/* harmony import */ var _common_Database__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ../common/Database */ "./src/common/Database.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Database", function() { return _common_Database__WEBPACK_IMPORTED_MODULE_48__["Database"]; });

/* harmony import */ var _guiElements_dam_context_menu_dam_context_menu_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ../guiElements/dam-context-menu/dam-context-menu.component */ "./src/guiElements/dam-context-menu/dam-context-menu.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DamContextMenuComponent", function() { return _guiElements_dam_context_menu_dam_context_menu_component__WEBPACK_IMPORTED_MODULE_49__["DamContextMenuComponent"]; });

/* harmony import */ var _mClass_classChild_Operations_eOperation__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ../mClass/classChild/Operations/eOperation */ "./src/mClass/classChild/Operations/eOperation.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EOperation", function() { return _mClass_classChild_Operations_eOperation__WEBPACK_IMPORTED_MODULE_50__["EOperation"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "OperationVisibility", function() { return _mClass_classChild_Operations_eOperation__WEBPACK_IMPORTED_MODULE_50__["OperationVisibility"]; });

/* harmony import */ var _mClass_classChild_Operations_eParameter__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ../mClass/classChild/Operations/eParameter */ "./src/mClass/classChild/Operations/eParameter.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EParameter", function() { return _mClass_classChild_Operations_eParameter__WEBPACK_IMPORTED_MODULE_51__["EParameter"]; });
...
const prjson2xml = _common_prj_json2xml_js__WEBPACK_IMPORTED_MODULE_5__;
const prxml2json = _common_prj_xml2json_js__WEBPACK_IMPORTED_MODULE_6__;
...
/*!****************************!*\
  !*** ./src/common/util.ts ***!
  \****************************/
/*! exports provided: Dictionary, MeasurableArrays, myFileReader, InputPopup, ShortAttribETypes, U, AttribETypes, Json, DetectZoom, ISize, Size, GraphSize, IPoint, GraphPoint, Point, FileReadTypeEnum */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Dictionary", function() { return Dictionary; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MeasurableArrays", function() { return MeasurableArrays; });
...
class InputPopup {
    constructor(title, txtpre, txtpost, event /* array of (['oninput', onInputFunction])*/, placeholder = null, value, inputType = 'input', inputSubType = null) {
        const value0 = value;
        if (!value) {
            value = '';
        }
...
class U {
    ...
    static measurableGetArrays(measureHtml, e) {
        if (!measureHtml) {
        ...
        for (i = 0; i < measureHtml.attributes.length; i++) {
            const attr = measureHtml.attributes[i];
    ...
    static measurableElementSetup($root, resizeConfig = null, dragConfig = null) {
        $root.find('.measurable').addBack('.measurable').each((i, h) => U.measurableElementSetupSingle(h, resizeConfig, dragConfig));
    }
    static measurableElementSetupSingle(elem, resizeConfig = null, dragConfig = null) {
    ...
    static sizeof(element, debug = false) {
    ...
    */
    ...
    static evalInContext(context, js) {
        let value;
        try { // for expressions
    ...
    static resizableBorderMouseMove(e) {
        ...
        const puntoDaFarCoinciderePT = cursor.clone();
    ...
    static computeMeasurableAttributeRightPart(str, attr, logic, measurableHtml, size = null, absTargetSize = null, relTargetSize = null, allowVariables = true) {
        str = U.changeBackVarTemplateDelimitersInMeasurablesAttr(str);
        if (!size) {
            size = U.sizeof(measurableHtml);
        }
        let relativeRoot = measurableHtml;
        ...
        const relativePos = size.tl().subtract(relTargetSize.tl(), false);
        const absolutePos = size.tl().subtract(absTargetSize.tl(), false);
        const str0debug = str;
        ...
        const borderFix = new Point(+rootStyle.borderTopWidth, +rootStyle.borderLeftWidth);
        ...
        for (i = 0; i < measurableHtml.attributes.length; i++) {
            const attr = measurableHtml.attributes[i];
    ...
    static computeResizableAttribute(attr, logic, measurableHtml, size = null, absTargetSize = null, relTargetSize = null) {
    ...
    static processMeasuring(logic, m, ui) {
        const size = U.sizeof(m.html);
        let relativeRoot = m.html;
        while (!relativeRoot.classList.contains('vertexShell')) {
            relativeRoot = relativeRoot.parentElement;
        }
        const absTargetSize = U.sizeof(relativeRoot);
    ...
    static processMeasurableExport(attr, logic, measurableHtml, size = null, absTargetSize = null) {
        const rule = U.computeResizableAttribute(attr, logic, measurableHtml, size, absTargetSize);
    ...
    static processMeasurableChain(attr0, logic, measurableHtml, size = null, absTargetSize = null, vertex, ui) {
        const destination = U.computeMeasurableAttributeRightPart('\'' + attr0.value + '\'', attr0, logic, measurableHtml, size, absTargetSize, null, false);
        const attributePseudoSelector = '->';
        ...
        for (i = 0; i < $targets.length; i++) {
            ...
            const attr = attribName ? html.attributes.getNamedItem(attribName) : null;
            if (!attr) {
            ...
            const val = $targets.length === 1 ? html.attributes.getNamedItem(attribName.substr(1)) : null;
            if (!val) {
                continue;
            }
    ...
    static processMeasurableConstraint(attr, logic, measurableHtml, size = null, absTargetSize = null) {
        return U.processMeasurableImport(attr, logic, measurableHtml, size, absTargetSize);
    }
    static processMeasurableImport(attr, logic, measurableHtml, size = null, absTargetSize = null) {
        let relativeRoot = measurableHtml;
        while (!relativeRoot.classList.contains('vertexShell')) {
            relativeRoot = relativeRoot.parentElement;
        }
        const $relativeHtml = $(relativeRoot).find(measurableHtml.getAttribute('relativeSelectorOf' + attr.name));
        U.pw($relativeHtml.length > 1, 'found more than one relative target (', $relativeHtml, ') assigned to: ', measurableHtml, ' root:', relativeRoot);
        const relativeSize = $relativeHtml.length ? U.sizeof($relativeHtml[0]) : absTargetSize;
        const rule = U.computeResizableAttribute(attr, logic, measurableHtml, size, absTargetSize, relativeSize);
        if (!rule) {
            return;
        }
        const outputSize = size.duplicate();
        ...
        const setx = (val) => { measurableHtml.setAttributeNS(null, 'x', '' + val); measurableHtml.style.left = val + 'px'; };
        const sety = (val) => { measurableHtml.setAttributeNS(null, 'y', '' + val); measurableHtml.style.top = val + 'px'; };
        const setw = (val) => { measurableHtml.setAttributeNS(null, 'width', '' + val); measurableHtml.style.width = val + 'px'; };
        const seth = (val) => { measurableHtml.setAttributeNS(null, 'height', '' + val); measurableHtml.style.height = val + 'px'; };
        const add = 1;
    ...
    static processMeasurableVariable(attr, logic, measurableHtml, size = null, absTargetSize = null, relTargetSize = null, allowVariables = true) {
    ...
    static processMeasurableDstyle(attr, logic, html, size = null, absTargetSize = null) {
    ...
    static removeDuplicates(arr0, clone = false) {
        if (!arr0)
            return [];
        const arr = clone ? U.cloneObj(arr0) : arr0;
        const found = [];
        let i;
        for (i = 0; i < arr.length; i++) {
            if (arr[i] in found) {
    ...
    static findTemplateList(str) {
        return undefined;
    }
    static makeSet(notice_willStripSpaces) {
...
class IPoint {
    ...
    moveOnNearestBorder(startVertexSize, clone, debug = true) {
        const pt = clone ? this.clone() : this;
...
class GraphPoint extends IPoint {
    ...
    clone() { return new GraphPoint(this.x, this.y); }
...
class MyConsole {
    constructor(root) {
        ...
        _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].addCss('console', '' +
    ...
    addEventListeners() {
        $(this.inputLine).off('keydown.input').on('keydown.input', (e) => { this.onKeyDown(e); });
        $(this.inputLine).off('keyup.input').on('keyup.input', (e) => { this.onKeyUp(e); });
    }
    onKeyUp(e) {
        switch (e.key) {
            default:
...
let DamContextMenuComponent = DamContextMenuComponent_1 = class DamContextMenuComponent {
    constructor() {
        ...
        $(document).off('click.hideContextMenu').on('click.hideContextMenu', (e) => this.checkIfHide(e));
    ...
    addEventListeners(location) {
        ...
        $html.find('.Vertex.delete').off('click.ctxMenu').on('click.ctxMenu', (e) => { m.delete(); });
        $html.find('.Vertex.minimize').off('click.ctxMenu').on('click.ctxMenu', (e) => { v.minimize(); });
        $html.find('.Vertex.up').off('click.ctxMenu').on('click.ctxMenu', (e) => { m.pushDown(); v.pushUp(); }); // must be opposites
        $html.find('.Vertex.down').off('click.ctxMenu').on('click.ctxMenu', (e) => { m.pushUp(); v.pushDown(); }); // must be opposites
        ...
        $html.find('.Feature.duplicate').off('click.ctxMenu').on('click.ctxMenu', (e) => { m.duplicate('_Copy', m.parent); });
        $html.find('.Feature.delete').off('click.ctxMenu').on('click.ctxMenu', (e) => { m.delete(); });
        $html.find('.Feature.minimize').off('click.ctxMenu').on('click.ctxMenu', (e) => { v.minimize(); });
        $html.find('.Feature.up').off('click.ctxMenu').on('click.ctxMenu', (e) => { m.pushUp(); v.refreshGUI(); });
        $html.find('.Feature.down').off('click.ctxMenu').on('click.ctxMenu', (e) => { m.pushDown(); v.refreshGUI(); });
...
class EdgePoint {
    ...
    show(debug = false) {
        const oldParent = this.html.parentNode;
        if (oldParent) {
...
class IEdge {
    ...
    getAllFakePoints(debug = false) {
        ...
        for (i = 0; i < parsedpts.pts.length; i++) {
            ...
            const fitToGrid = i !== 0 || i !== parsedpts.pts.length - 1;
            let fitHorizontal;
            let fitVertical;
    ...
    remove() {
        ...
        if (!(this instanceof _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["ExtEdge"])) {
            ...
            _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].pe(this.logic.edges[index] !== this, 'deleting wrong edge.');
            this.logic.edges[index] = null;
        }
        _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].arrayRemoveAll(this.owner.edges, this);
        let shell = '.EdgeShell';
    ...
    appendTailHead2(tail, pt1, pt2real, debug = false) {
        ...
        if (m === Number.POSITIVE_INFINITY) {
          ...
          (svg).setAttributeNS(null, 'x', '' + (pt1.x));
            ...
            const degree = _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].RadToDegree(degreeRad) + 90; // don't know why +90.
            if (debug) {
                this.owner.markg(pt2, false, 'blue');
            }
...
class IVertex {
    ...
    static getvertexByHtml(node) {
        _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].pe(!node || !(node instanceof Element), 'getVertexByHtml: parameter is not a DOM node:', node);
    ...
    draw() {
        try {
            ...
            _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].pw(true, 'failed to draw vertex of "' + this.logic().printableNameshort() + '".', e);
        }
    }
    draw0() {
        ...
        _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].pe(!this.classe || !(htmlRaw instanceof Element), 'class null?', this, htmlRaw);
    ...
    autosize(refreshVertex = true, refreshEdge = true, debug = false) {
        ...
        this.setSize(new _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["GraphSize"](this.size.x, this.size.y, actualSize.w, actualSize.h), refreshVertex, refreshEdge);
        return this;
    }
    ...
    addEventListeners() {
        ...
        $html.find('.Attribute, .Reference').off('contextmenu').on('contextmenu', (e) => { return this.featureContextMenu(e); });
        ...
        defaultResizeConfig.create = (e, ui) => this.measuringInit(ui, e);
        defaultDragConfig.create = (e, ui) => this.measuringInit(ui, e);
        defaultResizeConfig.resize = (e, ui) => this.measuringChanging(ui, e);
        defaultDragConfig.drag = (e, ui) => this.measuringChanging(ui, e);
        defaultResizeConfig.stop = (e, ui) => this.measuringChanged(ui, e);
        defaultDragConfig.stop = (e, ui) => this.measuringChanged(ui, e);
        //     console.log('measurableElementSetup:', defaultResizeConfig, defaultDragConfig);
        _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].measurableElementSetup($html, defaultResizeConfig, defaultDragConfig);
    }
    measuringInit(ui, e) {
        const m = _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].measurableGetArrays(null, e);
        console.log('measuringInit:', ui, e, m);
        let i;
        const size = _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].sizeof(m.html);
        const absTargetSize = this.owner.getSize();
        const logic = this.logic();
        for (i = 0; i < m.variables.length; i++) {
            _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].processMeasurableVariable(m.variables[i], logic, m.html, size, absTargetSize);
        }
        for (i = 0; i < m.dstyle.length; i++) {
            _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].processMeasurableDstyle(m.dstyle[i], logic, m.html, null, absTargetSize);
        }
        for (i = 0; i < m.imports.length; i++) {
            _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].processMeasurableImport(m.imports[i], logic, m.html, null, absTargetSize);
        }
    }
    measuringChanging(ui, e, measurHtml = null) {
        const m = _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].measurableGetArrays(measurHtml, e);
        ...
        // m.rules = [];
        // m.variables = [];
        _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].processMeasuring(this.logic(), m, ui);
    }
    measuringChanged(ui, e, measurHtml = null) {
        const m = _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].measurableGetArrays(measurHtml, e);
    ...
    */
    ...
    moveTo(graphPoint, gridIgnore = false) {
        ...
        this.setSize(new _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["GraphSize"](graphPoint.x, graphPoint.y, oldsize.w, oldsize.h), false, true);
    }
    logic(set = null) {
        if (set) {
...
class IGraph {
    ...
    addGraphEventListeners() {
        ...
        $graph.off('mousedown.graph').on('mousedown.graph', (evt) => { thiss.onMouseDown(evt); });
        $graph.off('mouseup.graph').on('mouseup.graph', (evt) => { thiss.onMouseUp(evt); });
        $graph.off('mousemove.graph').on('mousemove.graph', (evt) => { thiss.onMouseMove(evt); });
        ...
        $graph.off('mousedown.move').on('mousedown.move', (e) => {
            switch (this.cursorAction) {
                default: _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].pe(true, 'unexpected cursorAction:', this.cursorAction);
                case CursorAction.drag:
                case CursorAction.select:
                    const mp = _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["IVertex"].ChangePropertyBarContentClick(e);
                    if (mp instanceof _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["IModel"]) {
                        this.isMoving = _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["Point"].fromEvent(e);
                        this.clickedScroll = this.scroll.clone();
                    }
                    break;
                case CursorAction.multiselect: break;
            }
        });
        $graph.off('mouseup.move').on('mouseup.move', (e) => {
            if (this.isMoving) {
    ...
    ShowGrid(checked = null) {
        ...
        if (this.model === _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["Status"].status.mm) {
...
class StyleEditor {
    ...
    setStyleEditor($styleown, model, mp, style, templateLevel, indexedPath = null) {
        ...
        if (mp instanceof _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["IReference"]) {
            obj.isReference.disabled = obj.isReference.checked = true;
        }
        if (mp instanceof _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["IAttribute"]) {
            obj.isAttribute.disabled = obj.isAttribute.checked = true;
        }
        if (mp instanceof _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["EOperation"]) {
            obj.isOperation.disabled = obj.isOperation.checked = true;
        }
        if (mp instanceof _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["EParameter"]) {
            obj.isParameter.disabled = obj.isParameter.checked = true;
        }
        let styleown = style.htmlobj;
        if (styleown) {
        ...
        optgroup = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].toHtml('<optgroup label="Compatible Styles"></optgroup>');
        ...
        */
        const onStyleChange = () => {
            ...
            _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].pif(debug, '*** setting inheritable PRE. style.htmlobj:', style.htmlobj, ', style:', style, ', templateLevel:', templateLevel, 'templatelvl.parent:', templateLevel.parentElement, ', inputHtml:', inputHtml);
            ...
            if (!isInheritable && indexedPath)
                this.clickedLevel = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].followIndexesPath(mp.getHtmlOnGraph(), indexedPath);
            this.updateClickedGUIHighlight();
        ...
        const ownhtmlinput = $styleown.find('.html[contenteditable="true"]')[0];
        const measurableSelect = $styleown.find('select.attributetypeadd')[0];
        $styleown.find('button.addmeasurable').on('click', () => {
            this.addmeasurableAttributeButton(measurableSelect, $styleown, mp, style, templateLevel, ownhtmlinput, indexedPath);
        });
        for (i = 0; i < templateLevel.attributes.length; i++) {
            const a = templateLevel.attributes[i];
            if (a.name[0] === '_' || a.name.indexOf('r_') == 0 || a.name.indexOf('r_') == 0) {
                const val = this.clickedLevel.attributes.getNamedItem(a.name.substr(1));
                const style = null;
                this.addmeasurableAttributeButton(measurableSelect, $styleown, mp, style, templateLevel, ownhtmlinput, indexedPath, a, val);
            }
        }
        return indexedPath;
    }
    showMP(m, clickedLevel = null, asMeasurable = false, asEdge = null) {
        ...
        const realindexfollowed = { indexFollowed: [], debugArr: [] };
        let templateLevel = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].followIndexesPath(templateRoot, indexedPath, 'childNodes', realindexfollowed);
        ...
        if (realindexfollowed.indexFollowed.length !== indexedPath.length) {
            ...
            this.clickedLevel = clickedLevel = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].followIndexesPath(clickedRoot, indexedPath);
        }
        this.updateClickedGUIHighlight();
        // html set END.
        ...
        const htmlPath = this.setStyleEditor($styleown, model, m, style, templateLevel, indexedPath);
        ...
        let inheritedTemplateLevel = null;
        if (styleinherited) {
            const inheritedTemplateRoot = styleinherited.html;
            inheritedTemplateLevel = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].followIndexesPath(inheritedTemplateRoot, indexedPath, 'childNodes', realindexfollowed);
        ...
        const styleInheritableRoot = styleinheritable ? styleinheritable.html : null;
        if (!model.isM1()) {
    ...
    addmeasurableAttributeButton(measurableSelect, $styleeditor, m, style, clickedStyle, ownhtmlinput, htmlPath, attr = null, valAttr = null) {
        let val;
        let i;
        const template = this.getCopyOfTemplate(m, '.measurable._root', null, false);
        const $template = $(template);
        const nameinputprefix = $template.find('.nameprefix')[0];
        const nameinput = $template.find('input.name')[0];
        const operator = $template.find('select.operator')[0];
        const left = $template.find('input.leftside')[0];
        const right = $template.find('input.rightside')[0];
        const evaluation = $template.find('input.evaluation')[0];
        const outputErrorLeft = $template.find('.outputerror.left')[0];
        const outputErrorRight = $template.find('.outputerror.right')[0];
        ...
        if (attr) {
            ...
            _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].pe(!!operatorstr, 'option not found in select.', attr.value, operator);
            ...
            let name = measurableSelect.value + 0;
            name = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].increaseEndingNumber(name, false, false, (x) => { return !!clickedStyle.attributes.getNamedItem(x); });
        ...
        const changenamewhile = (x) => { return !!clickedStyle.attributes.getNamedItem(x); };
        const namechanged = () => {
            const oldname = template.dataset.name;
            const oldvalue = clickedStyle.getAttribute(oldname);
            let name = nameinput.dataset.prefix + nameinput.value;
            if (changenamewhile(name)) {
                name = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].increaseEndingNumber(name, false, false, changenamewhile);
            }
            setnameinput(name);
        ...
        const attrchanged = (isr_ = false) => {
            const is_ = left.value === '';
            const attrStr = (isr_ || is_ ? '' : left.value + ' ' + operator.value + ' ') + right.value;
            const templateList = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].removeDuplicates(_common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].findTemplateList(attrStr));
            const featuredependency = [];
            let i;
            for (i = 0; i < templateList.length; i++) {
                const template = templateList[i];
                const optionsSharp = template[1] + template[2];
                if (optionsSharp !== '##') {
                    _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].pw(true, 'gui debugging of template options different from the default "##" is not currently supported: ' + template);
                    continue;
                }
                const replacedArr = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].replaceSingleVarRaw(m, template); // last is the final output
                let j;
                let namesArr = '';
                let typesArr = '';
                for (j = 0; j < replacedArr.length; j++) {
                    namesArr += replacedArr[j].token + '.';
                    const typeDetail = replacedArr[j].value.typeDetail;
        ...
        const _right = () => {
            const htmldrew = m.getHtmlOnGraph();
            const sameElementInGraph = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].followIndexesPath(htmldrew, htmlPath);
            let result;
            ...
            try {
                result = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].computeMeasurableAttributeRightPart(right.value, sameElementInGraph.getAttributeNode(template.dataset.name), m, sameElementInGraph);
            }
            catch (e) {
        ...
        const constraintRight = () => {
            const result = _right();
            const sameElementInGraph = _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].followIndexesPath(m.getHtmlOnGraph(), htmlPath);
        ...
        switch (val) {
            default:
                _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].pe(true, 'unexpected select.attributetypeadd value:' + val);
                break;
            case 'r_':
            case 'd_':
        ...
        _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["U"].pe(!parent.length, 'parent not found:', val, ', editor:', $styleeditor);
...
class TopBar {
    ...
    static load_JSON_Text(e, prefix) {
        ...
        const popup = new _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["InputPopup"]('paste JSON/string data', '', '', [['input', onoutput], ['change', onoutput]], 'paste data here.', '', 'textarea');
    ...
    static download_JSON_String(e, modelstr) {
        ...
        const popup = new _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["InputPopup"]((model.isM() ? 'Model' : 'Metamodel') + ' eCore/JSON', '', '<br>Already copied to clipboard.', [], null, '' + savetxt, 'textarea');
        popup.show();
    }
    ...
    addEventListeners() {
        ...
        $m2.find('.save').off('click.btn').on('click.btn', (e) => { _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["Status"].status.mm.save(false, null); });
        $m1.find('.save').off('click.btn').on('click.btn', (e) => { _common_Joiner__WEBPACK_IMPORTED_MODULE_2__["Status"].status.m.save(false, null); });
        // download
...
class MAttribute extends _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["IAttribute"] {
    ...
    setValue(values = null, debug = false, autofix = true) {
...
class M2Reference extends _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["IReference"] {
    ...
    delete(linkStart = null, linkEnd = null) {
...
class MReference extends _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["IReference"] {
    ...
    */
    ...
    parse(json0, destructive = true) {
        ...
        let i;
        if (!this.mtarget) {
            this.mtarget = _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].newArray(this.metaParent.upperbound);
        }
        else
            this.mtarget.length = this.metaParent.upperbound;
        if (destructive) {
            this.clearTargets();
        }
...
class IReference extends _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["IFeature"] {
    ...
    clearTargets() {
        let i;
        const thiss = this instanceof _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["MReference"] ? this : null;
        for (i = 0; thiss && i < thiss.mtarget.length; i++) {
            thiss.setTarget(i, null);
        }
        if (thiss)
            thiss.mtarget = _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].newArray(this.metaParent.upperbound);
        this.edges = _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].newArray(this.metaParent.upperbound);
    }
    delete(linkStart = null, linkEnd = null) {
        if (linkStart === null && linkEnd === null) {
            super.delete();
    ...
    delete() {
        ...
        if (oldparent) {
            if (oldparent instanceof _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["IClass"]) {
                ...
                _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].pe(true, 'unrecognized parent class:' + _common_Joiner__WEBPACK_IMPORTED_MODULE_1__["U"].getTSClassName(this) + ':', this);
            }
        }
    }
...
module.exports = __webpack_require__(/*! C:\Users\diama\WebstormProjects\jjodel\src\main.ts */"./src/main.ts");
