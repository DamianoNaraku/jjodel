...
export class ModelPiece {
    ...
    static GetStyle(model, tsClass, checkCustomizedFirst = true) {
        ...
        const ret = U.cloneHtml($html[0], true);
    ...
    updateKey() {
        ...
        const pathIndex = U.getIndexesPath(this, 'parent', 'childrens');
    ...
    delete(refreshgui = true) {
        ...
        let i;
        let arr = U.shallowArrayCopy(this.views);
...
ModelPiece.idMax = 0;
export class ModelNone extends ModelPiece {
}
