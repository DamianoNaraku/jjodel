...
export class IClass extends IClassifier {
    constructor(parent, meta) {
        ...
        this.edges = [];
        if (this.parent) {
            U.ArrayAdd(this.parent.classes, this);
        }
        ...
        this.edgeStyleSelected = new EdgeStyle(EdgeModes.straight, 4, '#ffffff', new EdgePointStyle(5, 2, '#ffffff', '#ff0000'), new EdgeHeadStyle(25, 25, '#ffffff', '#ffffff'));
    }
    fullname() { return this.parent.name + '.' + this.name; }
    generateEdge() { U.pe(true, 'IClass.generateEdge() todo.'); return null; }
...
export class M3Class extends IClass {
    ...
    duplicate(nameAppend, newParent) { U.pe(true, 'Invalid operation: m3Class.duplicate()'); return this; }
    generateModel() { U.pe(true, 'Invalid operation: m3Class.generateModel()'); return this; }
    parse(json, destructive) {
        ...
        this.references = [];
        this.instances = [];
        const a = new M3Attribute(this, null);
        const r = new M3Reference(this, null);
        const o = new EOperation(this, null);
        const p = new EParameter(o, null);
    }
